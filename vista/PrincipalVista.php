                    ...
                    <div class="row">
                            ...
                            <div class="card bg-primary text-white mb-4 card-bg1">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link"
                                        href="?pagina=<?php configSistema::_Funcionarios_();?>">Ver Detalles</a>
                        ...
                        <div class="col-xl-4 col-md-4">
                            <div class="card bg-success text-white mb-4 card-bg2">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link"
                                        href="?pagina=<?php configSistema::_Deportes_();?>">Ver Detalles</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-4">
                            <div class="card bg-danger text-white mb-4 card-bg3">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link"
                                        href="?pagina=<?php configSistema::_Grupos_();?>">Ver Detalles</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card mb-4">
                                ...
                                <div class="card-body"><canvas id="myBarChart_masculino" width="100%"
                        ...
                        <div class="col-xl-6">
                            <div class="card mb-4">
                                ...
                                <div class="card-body"><canvas id="myBarChart_femenino" width="100%"
                                        height="40"></canvas></div>
                            </div>
                        </div>
                    </div>
