            ...
            <main>
                <div class="pagetitle">
                    ...
                    <section class="section profile m-3">
                        <div class="row">
                            <div class="col-xl-4">
                                <input type="hidden" name="cedula_usuario" id="cedula_usuario" value="" />
                                <div class="card">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-bordered">
                                            <li class="nav-item">
                                                <button class="nav-link active" data-bs-toggle="tab"
                                                    data-bs-target="#profile-overview">Detalle de la cuenta</button>
                                            </li>
                                        </ul>
                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php echo $_SESSION['usuario']['cedula']?>
                                                                </td>
                                                            </tr>
                                                            <tr>
