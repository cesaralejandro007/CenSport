                    ...
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="id_grupo_deportivo" class="form-control"
                                ...
                                <div class="col-12 mt-2">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="RifC" class="form-control" id="descripcion_grupo"
                                            required>
                                        ...
                                        <td class="project-actions text-left">
                                            <div class="d-flex">
                                                <button class="btn m-1 text-white px-2 py-1" style="background:#E67E22;"
                                                    ...
                                                    title="Editar"
                                                    onclick="cargar_datos(<?= $grupo['id_grupo_deportivo'] ?>);"><i
                                                ...
                                                <button class="btn m-1 px-2 py-1" style="background:#9D2323;color:white"
                                                    ...
                                                    onclick="eliminar(<?= $grupo['id_grupo_deportivo'] ?>);"><i
